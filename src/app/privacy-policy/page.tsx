    ...
    <div className="min-h-screen bg-maincolor flex flex-col text-gray-300">
      ...
      <header className="bg-maincolor border-b border-gray-700 p-4">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-3xl font-bold text-greensecondarycolor">
            Privacy Policy
          </h1>
        </div>
      </header>
      ...
      <main className="flex-grow flex items-center justify-center p-4">
        <div className="max-w-3xl space-y-6">
          ...
          <h2 className="text-2xl font-semibold text-greensecondarycolor">
            1. Introduction
          </h2>
          <p>
            Welcome to Ruang Bumi. We are committed to protecting your privacy.
          ...
          <ul className="list-disc pl-6 text-gray-400">
            ...
            <li>
              <strong>Transactional Information:</strong> Purchase history and
              payment details.
            </li>
            <li>
          ...
          <ul className="list-disc pl-6 text-gray-400">
            <li>
              ...
              support, and cloud storage providers.
            </li>
            <li>
              <strong>Legal Compliance:</strong> If required by law.
            </li>
            <li>
              <strong>Business Transfers:</strong> In case of a company merger
              or acquisition.
            </li>
          </ul>
          ...
          <div className="text-center mt-6">
            <Link
              href="/"
              className="inline-flex items-center px-6 py-3 bg-greenmaincolor text-gray-900 rounded-lg hover:bg-greensecondarycolor transition-colors duration-200 font-semibold"
            >
              Back to Home
            </Link>
          </div>
