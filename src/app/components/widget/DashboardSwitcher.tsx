      ...
      <div className="relative">
        <div className="flex flex-row items-center space-x-2">
          <button
            ...
            className={`inline-flex items-center justify-between w-40 px-4 py-2 text-sm font-medium text-gray-400 bg-secondarycolor  h-[50px] ${
              session === null && "cursor-not-allowed opacity-50"
            }`}
          >
