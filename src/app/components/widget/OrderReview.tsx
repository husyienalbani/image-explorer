...
export default function OrderReviewModal({
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/saveorder`,
        {
          method: "POST",
          headers: {
  ...
  const isValid =
    !agreedToTerms || !userData.name || !userData.email || !userData.phone;
    ...
    <>
      ...
      <div className="space-y-6">
        <div className="bg-maincolor rounded-md p-4 mb-4">
          <h3 className="text-sm font-medium text-greenmaincolor mb-2">
            Your selected scenes
          </h3>
          ...
          <div className="overflow-x-auto max-h-[200px] overflow-y-auto">
            <table className="min-w-full text-sm text-left">
              <thead className="text-xs border-b border-gray-700 sticky top-0 bg-secondarycolor z-10">
                <tr>
                  <th scope="col" className="py-2 px-3 text-gray-400">
                    Sensor name
                  </th>
                  <th scope="col" className="py-2 px-3 text-gray-400">
                    Date
              ...
              <tbody>
                {selectedItems.map((scene) => (
                  ...
                  >
                    <td className="py-2 px-3 text-greenmaincolor">
                      {scene.collection_vehicle_short}
                    </td>
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="border-t border-gray-700 my-2 pt-2 flex justify-between font-medium">
                ...
                <span className="text-greensecondarycolor">
                  ${orderData.estimatedPrice.toLocaleString()}
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="mt-4 flex items-start">
          ...
          <label htmlFor="terms" className="ml-2 text-xs text-gray-400">
            I agree to the processing and use of the selected imagery according
