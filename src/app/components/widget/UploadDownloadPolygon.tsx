...
const PolygonDownloadModal: React.FC<PolygonDownloadModalProps> = ({
  isOpen,
  onClose,
}) => {
    ...
    >
      <DialogPanel className="bg-maincolor p-6 rounded-md text-center text-white w-[90%] max-w-md">
        ...
        <p className="text-sm my-2 text-xs">
          Choose which format you would like to receive and your download will
          begin immediately.
        </p>
        <br />
        <form className="mt-4 text-sm">
          ...
          <div className="flex flex-col mb-3">
            ...
            >
              ...
              <option value="geojson" className="text-gray-200">
                GeoJSON
              </option>
              <option value="kml" className="text-gray-200">
                KML/KMZ
              </option>
              <option value="zip" className="text-gray-200">
                Shapefile (ZIP)
              </option>
            </select>
          </div>
        ...
        <div className="flex justify-end mt-4">
          <button
            ...
            className="bg-greenmaincolor px-3 py-1 rounded-sm"
          >
            Download
          </button>
        </div>
...
const PolygonUploadModal: React.FC<PolygonUploadModalProps> = ({
  isOpen,
  onClose,
  onUpload,
}) => {
    ...
    <div className="flex items-center justify-center gap-1 py-1">
      ...
      <div className="relative group">
        <button
          ...
          className={`flex items-center justify-center w-10 h-10 rounded-full ${
            mode === "upload" ? "bg-greenmaincolor" : "bg-maincolor"
      ...
      <div className="relative group">
        <button
          ...
          disabled={!isPolygon}
          className={`flex items-center justify-center w-10 h-10 rounded-full ${
            mode === "download" ? "bg-greenmaincolor" : "bg-maincolor"
          } ${
            isPolygon ? "hover:bg-greenmaincolor bg-maincolor" : "bg-white"
