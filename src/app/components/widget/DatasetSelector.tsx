...
const datasetCategories: DatasetCategory[] = [
  {
    ...
    datasets: [
      ...
      {
        name: "WorldView-3 SWIR (WV3_SWIR) - 3.7m 8-band SWIR",
        value: "WV3_SWIR",
      },
  ...
  },
  {
    ...
    datasets: [
      ...
      {
        name: "TerraSAR-X Staring SpotLight (TST) - up to 25-cm X-band SAR",
        value: "TST",
      },
      {
        name: "TerraSAR-X High Resolution SpotLight (THS) - up to 1-m X-band SAR",
        value: "THS",
      },
      {
        name: "TerraSAR-X SpotLight (TSL) - up to 2-m X-band SAR",
        value: "TSL",
      },
      {
        name: "TerraSAR-X StripMap (TSM) - up to 3-m X-band SAR",
        value: "TSM",
      },
      {
        name: "TerraSAR-X ScanSAR (TSC) - up to 18.5-m X-band SAR",
        value: "TSC",
      },
      {
        name: "TerraSAR-X Wide ScanSAR (TWSC) - up to 30-m X-band SAR",
        value: "TWSC",
      },
  ...
  },
  {
    ...
    datasets: [
      ...
      {
        name: "Jilin-1 Night (J1N) - nighttime 92-cm to 1.2-m 3-band",
        value: "J1N",
      },
      {
        name: "Jilin-1 Video (J1V) - video 92-cm to 1.2-m 3-band",
        value: "J1V",
      },
    ],
  },
  {
    ...
    datasets: [
      ...
      {
        name: "SuperView-Neo (SVN) - 30-cm 4-band; 50-cm 8-band",
        value: "SVN",
      },
      {
        name: "ZiYuan-3 (ZY3) - 2.1-m 4-band Mono; 2.5-m/3.5-m Pan Stereo",
        value: "ZY3",
      },
    ],
  },
  {
    ...
    datasets: [
      {
        name: "Digital Aerial Imagery (HEX) - 15-cm to 30-cm color/CIR mono",
        value: "HEX",
      },
      {
        name: "Digital Aerial Imagery DEM (HEXD) - 20-cm and up",
        value: "HEXD",
      },
    ],
  },
  ...
  {
    name: "ALOS",
    datasets: [{ name: "ALOS (ALOS) - 2.5-m Pan Mono/Stereo", value: "ALOS" }],
  },
  {
    ...
    >
      <DialogPanel className="bg-maincolor p-6 rounded-md text-white w-[90%] max-w-3xl max-h-[90%] flex flex-col">
        ...
        <div className="sticky top-0 bg-maincolor pb-4 z-10">
          <DialogTitle className="text-lg font-bold text-greensecondarycolor text-center">
            Dataset Selector
          </DialogTitle>
        </div>
        ...
        <div className="flex-1 overflow-y-auto space-y-2">
          {datasetCategories.map((category) => (
            <div
              key={category.name}
              className="bg-secondarycolor rounded-md p-2"
            >
              <div
                ...
                <div className="mt-2 space-y-1 pl-5">
                  {category.datasets.length > 0 ? (
                    category.datasets.map((dataset, datasetIndex) => {
                      const isChecked = filters.satellites.includes(
                        dataset.value
                      );
        ...
        <div className="sticky bottom-0 bg-maincolor pt-4 z-10">
          <div className="flex justify-end">
            <button
              onClick={onClose}
              className="bg-greensecondarycolor px-3 py-1"
            >
              Close
            </button>
          </div>
