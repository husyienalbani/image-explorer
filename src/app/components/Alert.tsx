...
const Alert: React.FC<AlertProps> = ({
  ...
  const icons: Record<AlertProps["category"], JSX.Element> = {
    ...
    warning: <AlertTriangle className="w-5 h-5 text-greenmaincolor" />,
  };

  return (
    <div className="fixed inset-0 flex items-center justify-center z-50">
      <div
        className={`flex items-center p-4 border-l-4 max-w-[90%] rounded-lg shadow-md transition-all duration-500 transform ${
